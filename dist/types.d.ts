...
export declare const enum Inject {
...
export declare const enum InjectType {
    /** Link to a CSS file. */
    css = "css",
    /** JS script file. */
    js = "js"
...
export declare enum ExternalPosition {
...
export declare type RollupPluginHTML2 = (options: IPluginOptions) => Plugin;
/**
